...
def main():
    ...
    parser.add_argument("--dataset_rate", type=float, default=1, help="Proportion of dataset to use")
    parser.add_argument("--train_dataset_rate", type=float, default=0.95, help="Proportion of dataset to use for training")
